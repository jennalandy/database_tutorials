...
libname conn2 odbc
required ="Driver={ODBC Driver 17 for SQL Server};Address=<server>;Database=<database>;UID=&id;PWD=&pass";

/*from proc sql directly*/
/*this is pretty convoluted*/
proc sql;
connect to odbc as conn
required="Driver={ODBC Driver 17 for SQL Server};Address=<address>;Database=<database>;UID=&id;PWD=&pass";
