...
The Cal Poly statistics department, at the current time, lacks a formal remote data course. This leaves it up to the discresion 
...
or the computer science database course to get into some of the really cool features of SQL. If you don't have the time or the preqrequists necessary for those, 
...
a simple "Rosetta Stone" that you can use to translate code from R or SAS into SQL. Given the iris dataset, all the following codeblocks will output the same data. 
