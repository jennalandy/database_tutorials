...
In the code blocks below, we assume you've already connected to your database and have named it as shown in the third chapter on [connecting to a database](03-connections.Rmd).
...
- [SQL Keywords Reference by w3schools](https://www.w3schools.com/sql/sql_ref_keywords.asp): if there are multiple options (i.e. **MySQL** or **SQL Server / Oracle / MS Access**) make sure you follow instructions for **SQL Server**
- [SQL Tutorial by w3schools](https://www.w3schools.com/sql/)
- [SQL Server Basics by sqlservertutorial](https://www.sqlservertutorial.net/sql-server-basics/)

## Julia
TODO: add Julia query info

## R
In R, you can choose to read a full table into a `data.frame` or query a subsection with a sql query.
