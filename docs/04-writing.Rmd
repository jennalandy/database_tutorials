...
In the code blocks below, we assume you've already connected to your database and have named it as shown in the previous chapter on [connecting to a database](03-connections.Rmd).

## Julia  

TODO: add drop table if exists.
...
## SAS 
TODO: update this so it assumes conn has already been defined using a libname
TODO: split into code chunks and add notes in between instead of relying on comments
```sas
