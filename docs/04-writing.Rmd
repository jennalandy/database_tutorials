...
Once you are connected to a database, you can write tables to it (assuming you have write access). If you're only using a database to access data, and aren't writing to it, feel free to continue to the next chapter on [querying a database][Querying a Database].
